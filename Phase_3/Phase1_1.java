...
public class Phase1_1{
  ...
  static ArrayList<Axis> axis = new ArrayList<Axis>();
  ...
  public static ArrayList<Segment> input(boolean defo, int version){
    try{
      if(defo){
        if(version<5 && version>0)file_name = "data1_" + version + ".txt";
        else if(version>4 && version <9)file_name = "data2_" + version + ".txt";
